...
SITE_URL="https://mojzis.github.io/biston"
...
> Clone detector and refactor suggester for Python — finds duplicated functions and proposes anti-unified templates.
...
echo "# biston — Full Documentation" >> "$BOOK_DIR/llms-full.txt"
